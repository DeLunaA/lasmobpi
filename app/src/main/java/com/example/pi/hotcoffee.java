...
public class hotcoffee extends AppCompatActivity {
    ...
    PanierDB db  = new PanierDB(hotcoffee.this);
    panier panier;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)  {
                Intent act2 = new Intent(hotcoffee.this ,orders.class);
                startActivity(act2);
            }
        ...
        im1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)  {
                ...
                if(tcheckuser==true)
                {
                    ...
                    db.close();
                    Toast.makeText(hotcoffee.this,"Iteam added with success",Toast.LENGTH_SHORT).show();
                }
                else{
